package com.bStack.TestListeners;
...
public class ExtentITestNGListeners implements ITestListener
{
	...
	public void onTestSuccess(ITestResult result) {
	    ...
	    parentTest.get().log(Status.PASS,result.getName()+"TestCase Passed!");
	...
	public void onTestFailure(ITestResult result) 
	{
		...
		parentTest.get().log(Status.FAIL,result.getName()+"TestCase Failed");
